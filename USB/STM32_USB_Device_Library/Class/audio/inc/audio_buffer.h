...
#define UM_BUFFER_FLAG_FRAGMENTATION_NEEDED 0x8
...
#define GET_FRAGMENTATION_NEEDED_FLAG(flag) ((flag) & UM_BUFFER_FLAG_FRAGMENTATION_NEEDED)
...
#define TOGGLE_FRAGMENTATION_NEEDED_FLAG(flag)  (flag) = ((flag) ^ UM_BUFFER_FLAG_FRAGMENTATION_NEEDED)
